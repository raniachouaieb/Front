...
<head>
    ...
    <link rel="favicon" href="{{ asset('welcome/assets/images/favicon.png')}}">
    <link rel="stylesheet" media="screen" href="http://fonts.googleapis.com/css?family=Open+Sans:300,400,700">
    <link rel="stylesheet" href="{{ asset('welcome/assets/css/bootstrap.min.css')}}">
    <link rel="stylesheet" href="{{ asset('welcome/assets/css/font-awesome.min.css')}}">
    <link rel="stylesheet" href="{{ asset('welcome/assets/css/bootstrap-theme.css')}}" media="screen">
    <link rel="stylesheet" href="{{ asset('welcome/assets/css/style.css')}}">
    <link rel='stylesheet' id='camera-css'  href="{{ asset('welcome/assets/css/camera.css')}}" type='text/css' media='all'>
    <!-- HTML5 shim and Respond.js IE8 support of HTML5 elements and media queries -->
    <!--[if lt IE 9]>
    <script src="{{ asset('welcome/assets/js/html5shiv.js')}}"></script>
    <script src="{{ asset('welcome/assets/js/respond.min.js')}}"></script>
    <![endif]-->
</head>
<body>
<!-- Fixed navbar -->
    ...
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="index.html">
                <img src="{{ asset('welcome/assets/images/logo.png')}}" alt="Techro HTML5 template"></a>
        </div>
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav pull-right mainNav">
                <li class="c1 active"><a href="{{ url('/') }}">Home</a></li>
                <li class="c2"><a href="#">About</a></li>
                <li class="c3"><a href="{{route('getLogin')}}">Login</a></li>
                <li class="c4">  @if (Route::has('getRegister'))<a href="{{route('getRegister')}}">Register</a>@endif</li>
    ...
    <div class="container">
        ...
        <div class="fluid_container">
            <div class="camera_wrap camera_emboss pattern_1" id="camera_wrap_4">
                <div data-thumb="{{ asset('welcome/assets/images/slides/thumbs/img1.jpg')}}" data-src="{{ asset('welcome/assets/images/slides/img1.jpg')}}">
                    <h2>We develop.</h2>
                </div>
                <div data-thumb="{{ asset('welcome/assets/images/slides/thumbs/img2.jpg')}}" data-src="{{ asset('welcome/assets/images/slides/img2.jpg')}}">
                </div>
                <div data-thumb="{{ asset('welcome/assets/images/slides/thumbs/img3.jpg')}}" data-src="{{ asset('welcome/assets/images/slides/img3.jpg')}}">
                </div>
            </div><!-- #camera_wrap_3 -->
        </div><!-- .fluid_container -->
    </div>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-4 col-sm-12">
                <div class="newsBox">
                    <div class="thumbnail">
                        <figure><img src="{{ asset('welcome/assets/images/news2.jpg')}}" alt=""></figure>
            ...
            <div class="col-lg-4 col-md-4 col-sm-12">
                <div class="newsBox">
                    <div class="thumbnail">
                        <figure><img src="{{ asset('welcome/assets/images/news3.jpg')}}" alt=""></figure>
                        <div class="caption maxheight2">
                            <div class="box_inner">
                                <div class="box">
                                    <h4>Photography   </h4>
            ...
            <div class="col-lg-4 col-md-4 col-sm-12">
                <div class="newsBox">
                    <div class="thumbnail">
                        <figure><img src="{{ asset('welcome/assets/images/news4.jpg')}}" alt=""></figure>
                        <div class="caption maxheight2">
                            <div class="box_inner">
                                <div class="box">
                                    <h4>Audio Editing</h4>
...
<script src="{{ asset('welcome/assets/js/modernizr-latest.js')}}"></script>
<script type='text/javascript' src="{{ asset('welcome/assets/js/jquery.min.js')}}"></script>
<script type='text/javascript' src="{{ asset('welcome/assets/js/fancybox/jquery.fancybox.pack.js')}}"></script>

<script type='text/javascript' src="{{ asset('welcome/assets/js/jquery.mobile.customized.min.js')}}"></script>
<script type='text/javascript' src="{{ asset('welcome/assets/js/jquery.easing.1.3.js')}}"></script>
<script type='text/javascript' src="{{ asset('welcome/assets/js/camera.min.js')}}"></script>
...
<script>
    jQuery(function(){
        ...
        jQuery('#camera_wrap_4').camera({
            ...
            navigation: false,
            opacityOnGrid: false,
            //imagePath:  'welcome/assets/images/',
        });
